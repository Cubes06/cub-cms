<?php
    ...
    class Application_Model_DbTable_CmsIndexslides extends Zend_Db_Table_Abstract {
        ...
        protected $_name = 'cms_index_slides';  //ovde ide naziv tabele

        
        /**
         * @param int $id
         * @return null|array Associative array as cms_indexSlides table columns or NULL if not found
         */
        ...
        /**
         * @param array $indexSlide  Associative array as cms_indexSlides table columns or NULL if not found
        ...
        public function deleteIndexSlide($id) {
            ...
            //this updates order_numbers of all index-slides whose order_numbers are greater than the current order_numer
            $this->update(
        ...
        public function getActiveIndexSlides() {
            $select = $this->select();
            
            $select->from('cms_indexSlides', array("num" => "COUNT(*)"))
        ...
        public function getTotalIndexSlides() {
            $select = $this->select();
    ...
    } //end of: class Application_Model_DbTable_CmsIndexSlides
