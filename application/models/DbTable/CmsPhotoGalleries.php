<?php
    ...
    class Application_Model_DbTable_CmsPhotoGalleries extends Zend_Db_Table_Abstract {
        ...
        protected $_name = 'cms_photo_galleries';  //ovde ide naziv tabele

        
        /**
         * @param int $id
         * @return null|array Associative array as cms_photoGalleries table columns or NULL if not found
         */
        ...
        /**
         * @param array $photoGallery  Associative array as cms_photoGalleries table columns or NULL if not found
        ...
        public function deletePhotoGallery($id) {
            ...
            //this updates order_numbers of all photoGalleries whose order_numbers are greater than the current order_numer
            $this->update(
        ...
        public function getActivePhotoGalleries() {
            $select = $this->select();
            
            $select->from('cms_photoGalleries', array("num" => "COUNT(*)"))
        ...
        public function getTotalPhotoGalleries() {
            $select = $this->select();
    ...
    } //end of: class Application_Model_DbTable_CmsPhotoGalleries
