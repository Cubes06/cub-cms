<?php
    ...
    class Application_Model_DbTable_CmsPhotos extends Zend_Db_Table_Abstract {
        ...
        protected $_name = 'cms_photos';  //ovde ide naziv tabele

        
        /**
         * @param int $id
         * @return null|array Associative array as cms_photos table columns or NULL if not found
         */
        ...
        /**
         * @param array $photo  Associative array as cms_photos table columns or NULL if not found
        ...
        public function deletePhoto($id) {
            ...
            //this updates order_numbers of all photos whose order_numbers are greater than the current order_numer
            $this->update(
        ...
        public function getActivePhotos() {
            ...
            $select->from('cms_photos', array("num" => "COUNT(*)"))
    ...
    } //end of: class Application_Model_DbTable_CmsPhotos
